...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/ChxisB/Talon/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for ChxisB/Talon...\n")
...
console.log("Fetching npm all-time downloads for talon-ai...\n")
const npmDownloads = await fetchNpmDownloads("talon-ai")
