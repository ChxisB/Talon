...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@talon-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@talon/v2/ToolRegistry") {}
