...
export class Service extends Context.Service<Service, Interface>()("@talon/v2/FileSystem/Search") {}
...
export const defaultLayer = Layer.unwrap(
  Effect.sync(() => (Flag.TALON_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
