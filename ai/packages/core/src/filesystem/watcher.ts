...
declare const TALON_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof TALON_LIBC === "undefined" ? undefined : TALON_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@talon/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.TALON_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.TALON_EXPERIMENTAL_FILEWATCHER) {
