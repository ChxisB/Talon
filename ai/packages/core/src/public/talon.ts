...
export class Service extends Context.Service<Service, Interface>()("@talon/public/OpenCode") {}
...
>()("@talon/public/OpenCode/SessionModelValidation") {}
