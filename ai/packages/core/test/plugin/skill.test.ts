...
import { SkillDiscovery } from "@talon-ai/core/skill/discovery"
...
describe("SkillPlugin.Plugin", () => {
  it.effect("registers the built-in customize-talon skill", () =>
    Effect.gen(function* () {
      ...
      expect(yield* skill.list()).toContainEqual(
        expect.objectContaining({
          ...
          description: expect.stringContaining("talon's own configuration"),
        }),
      )
    }),
  )
