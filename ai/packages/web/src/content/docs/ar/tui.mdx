...
هذا منفصل عن `talon.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
استخدم `TALON_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `talon.default`.
