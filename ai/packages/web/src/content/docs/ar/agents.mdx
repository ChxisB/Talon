...
هيّئ الوكلاء في ملف إعدادات `talon.json`:
...
- عام: `~/.config/talon/agents/`
- لكل مشروع: `.talon/agents/`
...
يستخدم معرّف النموذج في إعدادات OpenCode الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [OpenCode Zen](/docs/zen)، فستستخدم `talon/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `talon models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/ChxisB/Talon).
:::
