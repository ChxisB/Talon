...
أنشئ الملف `.talon/commands/test.md`:
...
- على مستوى النظام: `~/.config/talon/commands/`
- لكل مشروع: `.talon/commands/`
...
يتضمن talon عدة أوامر مضمنة مثل `/init` و`/undo` و`/redo` و`/share` و`/help`؛ [اعرف المزيد](/docs/tui#commands).
