...
يستخدم [معرّف النموذج](/docs/config/#models) في إعدادات OpenCode الصيغة `talon/<model-id>`. على سبيل المثال، بالنسبة إلى GPT 5.5، ستستخدم `talon/gpt-5.5` في إعداداتك.
