...
![واجهة OpenCode في terminal مع سمة talon](../../../assets/lander/screenshot.png)
...
- **باستخدام Homebrew على macOS وLinux**
  ...
  > نوصي باستخدام tap الخاص بـ OpenCode للحصول على أحدث الإصدارات. صيغة `brew install talon` الرسمية تُدار بواسطة فريق Homebrew ويتم تحديثها بوتيرة أقل.
...
يمكنك أيضا تنزيل الملف التنفيذي من صفحة [Releases](https://github.com/ChxisB/Talon/releases).
...
1. شغّل الأمر `/connect` في واجهة TUI، واختر talon، ثم انتقل إلى [talon.ai/auth](https://talon.ai/auth).
...
إليك [مثالا لمحادثة](https://talon.ai/s/4XP1fce5) مع OpenCode.
