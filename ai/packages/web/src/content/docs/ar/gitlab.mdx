...
هنا نستخدم مكوّن CI/CD أنشأه المجتمع لـ OpenCode — [nagyv/gitlab-talon](https://gitlab.com/nagyv/gitlab-talon).
...
لمزيد من المُدخلات وحالات الاستخدام، [اطّلع على الوثائق](https://gitlab.com/explore/catalog/nagyv/gitlab-talon) الخاصة بهذا المكوّن.
...
اذكر `@talon` في تعليق، وسينفّذ OpenCode المهام ضمن خط أنابيب GitLab CI لديك.
...
:::tip
يمكنك ضبطه لاستخدام عبارة تشغيل مختلفة عن `@talon`.
:::
