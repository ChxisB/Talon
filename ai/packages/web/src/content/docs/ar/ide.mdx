...
يتكامل OpenCode مع VS Code و Cursor أو أي IDE يدعم terminal. ما عليك سوى تشغيل `talon` في terminal للبدء.
...
3. شغّل `talon` - سيتم تثبيت الامتداد تلقائيا
...
- تأكد من أنك تشغّل `talon` داخل terminal المدمجة.
