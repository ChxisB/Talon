---
title: SDK
description: Client JS type-safe per il server talon.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

L'SDK JS/TS di talon fornisce un client type-safe per interagire con il server.
Usalo per creare integrazioni e controllare talon in modo programmatico.
...
Puoi passare un oggetto di configurazione per personalizzare il comportamento. L'istanza legge comunque `talon.json`, ma puoi sovrascrivere o aggiungere configurazione inline:
...
Se hai gia un'istanza di talon in esecuzione, puoi creare un client per collegarti:
