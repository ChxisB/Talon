...
OpenCode si integra con VS Code, Cursor o qualunque IDE che supporti un terminale. Basta eseguire `talon` nel terminale per iniziare.
...
3. Esegui `talon` - l'estensione si installa automaticamente
...
- Assicurati di eseguire `talon` nel terminale integrato.
