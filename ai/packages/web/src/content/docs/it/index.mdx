...
![OpenCode TUI con il tema talon](../../../assets/lander/screenshot.png)
...
- **Con Homebrew su macOS e Linux**
  ...
  > Ti consigliamo di usare il tap di OpenCode per avere le release piu aggiornate. La formula ufficiale `brew install talon` e mantenuta dal team Homebrew e viene aggiornata meno spesso.
...
Puoi anche scaricare il binario dalle [Releases](https://github.com/ChxisB/Talon/releases).
...
1. Esegui il comando `/connect` nella TUI, seleziona talon e vai su [talon.ai/auth](https://talon.ai/auth).
...
Ecco un'[esempio di conversazione](https://talon.ai/s/4XP1fce5) con OpenCode.
