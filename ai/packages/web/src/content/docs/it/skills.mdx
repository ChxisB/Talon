...
- Config di progetto: `.talon/skills/<name>/SKILL.md`
- Config globale: `~/.config/talon/skills/<name>/SKILL.md`
...
Carica qualsiasi `skills/*/SKILL.md` corrispondente in `.talon/` e qualsiasi `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` corrispondente lungo il percorso.

Le definizioni globali vengono caricate anche da `~/.config/talon/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` e `~/.agents/skills/*/SKILL.md`.
...
Crea `.talon/skills/git-release/SKILL.md` cosi':
...
Controlla a quali skill gli agenti possono accedere usando permessi basati su pattern in `talon.json`:
...
**Per agenti integrati** (in `talon.json`):
