...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `talon.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare talon nella tua organizzazione.
