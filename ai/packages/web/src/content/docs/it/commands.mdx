...
- Globale: `~/.config/talon/commands/`
- Per progetto: `.talon/commands/`
...
talon include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
