...
Qui usiamo un componente CI/CD creato dalla community per OpenCode — [nagyv/gitlab-talon](https://gitlab.com/nagyv/gitlab-talon).
...
Per altri input e casi d'uso, [consulta la documentazione](https://gitlab.com/explore/catalog/nagyv/gitlab-talon) di questo componente.
...
Menziona `@talon` in un commento e OpenCode eseguira' i task dentro la tua pipeline GitLab CI.
...
:::tip
Puoi configurare una frase trigger diversa da `@talon`.
:::
