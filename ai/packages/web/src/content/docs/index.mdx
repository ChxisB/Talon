...
- **Using Homebrew on macOS and Linux**
  ...
  > We recommend using the OpenCode tap for the most up to date releases. The official `brew install talon` formula is maintained by the Homebrew team and is updated less frequently.
...
You can also grab the binary from the [Releases](https://github.com/ChxisB/Talon/releases).
...
1. Run the `/connect` command in the TUI, select talon, and head to [talon.ai/auth](https://talon.ai/auth).
...
Here's an [example conversation](https://talon.ai/s/4XP1fce5) with OpenCode.
