...
กำหนดค่าเอเจนต์ในไฟล์ `talon.json` ของคุณ:
...
- ระดับผู้ใช้ (Global): `~/.config/talon/agents/`
- ระดับโปรเจ็กต์: `.talon/agents/`
...
:::tip
ใช้ `talon models` เพื่อดูรายการตัวเลือกทั้งหมด
:::
...
:::tip
คุณมีเอเจนต์เจ๋งๆ ที่ต้องการแบ่งปันหรือไม่? [ส่ง PR มาที่นี่](https://github.com/ChxisB/Talon)
:::
