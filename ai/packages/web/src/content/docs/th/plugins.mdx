...
- `.talon/plugins/` - ​​ปลั๊กอินระดับโครงการ
- `~/.config/talon/plugins/` - ​​ปลั๊กอินทั่วโลก
...
**ปลั๊กอิน npm** ได้รับการติดตั้งโดยอัตโนมัติโดยใช้ Bun เมื่อเริ่มต้น แพ็คเกจและการขึ้นต่อกันถูกแคชไว้ใน `~/.cache/talon/node_modules/`
...
1. การกำหนดค่าส่วนกลาง (`~/.config/talon/talon.json`)
2. การกำหนดค่าโครงการ (`talon.json`)
3. ไดเร็กทอรีปลั๊กอินสากล (`~/.config/talon/plugins/`)
4. ไดเรกทอรีปลั๊กอินโครงการ (`.talon/plugins/`)
...
- `client`: ไคลเอนต์ talon SDK สำหรับการโต้ตอบกับ AI
...
นี่คือตัวอย่างบางส่วนของปลั๊กอินที่คุณสามารถใช้เพื่อขยาย talon
...
ป้องกันไม่ให้ talon อ่านไฟล์ `.env`:
...
ปลั๊กอินยังสามารถเพิ่มเครื่องมือที่กำหนดเองให้กับ talon:
...
ตัวช่วย `tool` สร้างเครื่องมือแบบกำหนดเองที่สามารถเรียกใช้ talon ได้ ใช้ฟังก์ชัน Zod schema และส่งกลับคำจำกัดความของเครื่องมือด้วย:
...
เครื่องมือที่คุณกำหนดเองจะพร้อมใช้งานสำหรับ talon ควบคู่ไปกับเครื่องมือในตัว
...
ระดับ: `debug`, `info`, `warn`, `error` ดู[SDKเอกสารประกอบ](https://talon.ai/docs/sdk)สำหรับรายละเอียด
