...
- **在 macOS 和 Linux 上使用 Homebrew**
  ...
  > 我們推薦使用 OpenCode tap 以取得最新版本。官方的 `brew install talon` formula 由 Homebrew 團隊維護，更新頻率較低。
...
您也可以從 [Releases](https://github.com/ChxisB/Talon/releases) 頁面直接下載二進位檔案。
...
1. 在 TUI 中執行 `/connect` 指令，選擇 talon，然後前往 [talon.ai/auth](https://talon.ai/auth)。
...
這是一個與 OpenCode 的[範例對話](https://talon.ai/s/4XP1fce5)。
