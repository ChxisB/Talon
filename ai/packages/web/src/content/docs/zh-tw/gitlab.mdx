...
這裡我們使用的是社群建立的 OpenCode CI/CD 元件 — [nagyv/gitlab-talon](https://gitlab.com/nagyv/gitlab-talon)。
...
有關更多輸入參數和使用情境，請[查看該元件的文件](https://gitlab.com/explore/catalog/nagyv/gitlab-talon)。
...
在評論中提及 `@talon`，OpenCode 將在您的 GitLab CI 管線中執行任務。
