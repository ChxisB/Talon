...
By default, OpenCode uses our own `talon` theme.
...
2. **User config directory** - Defined in `~/.config/talon/themes/*.json` or `$XDG_CONFIG_HOME/talon/themes/*.json`
3. **Project root directory** - Defined in the `<project-root>/.talon/themes/*.json`
4. **Current working directory** - Defined in `./.talon/themes/*.json`
