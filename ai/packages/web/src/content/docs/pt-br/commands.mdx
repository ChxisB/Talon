...
Você pode adicionar comandos personalizados através da configuração do talon ou criando arquivos markdown no diretório `commands/`.

---

### JSON

Use a opção `command` na sua [configuração](/docs/config) do talon:
...
- Global: `~/.config/talon/commands/`
- Por projeto: `.talon/commands/`
...
talon inclui vários comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [saiba mais](/docs/tui#commands).
