...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `TALON_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og talon åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din talon-konfiguration.
