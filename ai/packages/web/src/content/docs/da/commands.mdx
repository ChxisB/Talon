...
- Globalt: `~/.config/talon/commands/`
- Pr. projekt: `.talon/commands/`
...
talon indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
