...
- **Brug af Homebrew på macOS og Linux**
  ...
  > Vi anbefaler at bruge OpenCode-tap for at få de mest opdaterede udgivelser. Den officielle `brew install talon`-formel vedligeholdes af Homebrew-teamet og opdateret sjældnere.
...
Du kan også få fat i binæren fra [Releases](https://github.com/ChxisB/Talon/releases).
