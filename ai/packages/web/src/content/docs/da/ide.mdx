...
OpenCode integreres med VS Code, Cursor eller enhver IDE, der understøtter en terminal. Bare kør `talon` i terminalen for at komme i gang.
...
3. Kør `talon` - udvidelsen installeres automatisk
...
- Sørg for, at du kører `talon` i den integrerede terminal.
