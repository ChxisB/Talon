...
Her bruger vi en community-skabt CI/CD-komponent til OpenCode — [nagyv/gitlab-talon](https://gitlab.com/nagyv/gitlab-talon).
...
For flere input og use cases [check out the docs](https://gitlab.com/explore/catalog/nagyv/gitlab-talon) for denne komponent.
...
Nævn `@talon` i en kommentar, og OpenCode vil udføre opgaver i din GitLab CI-pipeline.
...
:::tip
Du kan konfigurere til at bruge en anden udløsersætning end `@talon`.
:::
