...
Som standard bruger OpenCode vårt eget `talon`-tema.
...
2. **Brugerkonfigurasjonskatalog** - Definert i `~/.config/talon/themes/*.json` eller `$XDG_CONFIG_HOME/talon/themes/*.json`
3. **Prosjektrotkatalog** - Definert i `<project-root>/.talon/themes/*.json`
4. **Nuværende arbejdskatalog** - Definert i `./.talon/themes/*.json`
