...
OpenCode se integra con VS Code, Cursor o cualquier IDE que admita un terminal. Simplemente ejecute `talon` en la terminal para comenzar.
...
3. Ejecute `talon`: la extensión se instala automáticamente
...
- Asegúrese de estar ejecutando `talon` en el terminal integrado.
