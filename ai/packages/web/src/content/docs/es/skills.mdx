...
- Configuración del proyecto: `.talon/skills/<name>/SKILL.md`
- Configuración global: `~/.config/talon/skills/<name>/SKILL.md`
...
Carga cualquier `skills/*/SKILL.md` coincidente en `.talon/` y cualquier `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` coincidente a lo largo del camino.

Las definiciones globales también se cargan desde `~/.config/talon/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` y `~/.agents/skills/*/SKILL.md`.
...
Crea `.talon/skills/git-release/SKILL.md` así:
...
Controle a qué agentes de habilidades pueden acceder utilizando permisos basados ​​en patrones en `talon.json`:
...
**Para agentes integrados** (en `talon.json`):
