...
De forma predeterminada, OpenCode usa nuestro propio tema `talon`.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/talon/themes/*.json` o `$XDG_CONFIG_HOME/talon/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.talon/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.talon/themes/*.json`
