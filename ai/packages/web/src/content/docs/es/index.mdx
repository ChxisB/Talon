...
![OpenCode TUI con el tema talon](../../../assets/lander/screenshot.png)
...
- **Usando Homebrew en macOS y Linux**
  ...
  > Recomendamos utilizar el tap OpenCode para las versiones más actualizadas. La fórmula oficial `brew install talon` la mantiene el equipo Homebrew y se actualiza con menos frecuencia.
...
También puede obtener el binario desde [Versiones](https://github.com/ChxisB/Talon/releases).
...
1. Ejecute el comando `/connect` en la TUI, seleccione talon y diríjase a [talon.ai/auth](https://talon.ai/auth).
...
Aquí tiene una [conversación de ejemplo](https://talon.ai/s/4XP1fce5) con OpenCode.
