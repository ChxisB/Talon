...
Aquí estamos utilizando un componente CI/CD creado por la comunidad para OpenCode — [nagyv/gitlab-talon](https://gitlab.com/nagyv/gitlab-talon).
...
Para obtener más entradas y casos de uso, [consulte los documentos](https://gitlab.com/explore/catalog/nagyv/gitlab-talon) de este componente.
...
Mencione `@talon` en un comentario y OpenCode ejecutará tareas dentro de su canal de CI GitLab.
...
:::tip
Puede configurarlo para utilizar una frase de activación diferente a `@talon`.
:::
