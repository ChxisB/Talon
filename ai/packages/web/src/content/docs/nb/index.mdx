...
![OpenCode TUI med talon-temaet](../../../assets/lander/screenshot.png)
...
- **Bruke Homebrew på macOS og Linux**
  ...
  > Vi anbefaler å bruke OpenCode-tappen for de mest oppdaterte utgivelsene. Den offisielle `brew install talon`-formelen vedlikeholdes av Homebrew-teamet og oppdateres sjeldnere.
...
Du kan også hente binæren fra [Releases](https://github.com/ChxisB/Talon/releases).
...
1. Kjør kommandoen `/connect` i TUI, velg OpenCode og gå til [talon.ai/auth](https://talon.ai/auth).
...
Her er en [eksempelsamtale](https://talon.ai/s/4XP1fce5) med OpenCode.
