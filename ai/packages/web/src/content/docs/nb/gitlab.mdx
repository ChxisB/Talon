---
title: GitLab
description: Bruk talon i GitLab-problemer og Merge Requests.
---
...
Her bruker vi en fellesskapsskapt CI/CD-komponent for OpenCode — [nagyv/gitlab-talon](https://gitlab.com/nagyv/gitlab-talon).
...
For flere inndata og brukstilfeller [sjekk ut dokumentene](https://gitlab.com/explore/catalog/nagyv/gitlab-talon) for denne komponenten.
...
Nevn `@talon` i en kommentar, og OpenCode vil utføre oppgaver innenfor din GitLab CI-pipeline.
