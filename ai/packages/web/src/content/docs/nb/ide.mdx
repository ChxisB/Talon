...
OpenCode integreres med VS Code, Cursor eller en hvilken som helst IDE som støtter en terminal. Bare kjør `talon` i terminalen for å komme i gang.
...
3. Kjør `talon` - utvidelsen installeres automatisk
...
- Sørg for at du kjører `talon` i den integrerte terminalen.
