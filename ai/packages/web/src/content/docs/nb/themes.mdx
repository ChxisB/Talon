...
Som standard bruker OpenCode vårt eget `talon`-tema.
...
2. **Brukerkonfigurasjonskatalog** - Definert i `~/.config/talon/themes/*.json` eller `$XDG_CONFIG_HOME/talon/themes/*.json`
3. **Prosjektrotkatalog** - Definert i `<project-root>/.talon/themes/*.json`
4. **Gjeldende arbeidskatalog** - Definert i `./.talon/themes/*.json`
