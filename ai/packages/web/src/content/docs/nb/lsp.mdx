---
title: LSP-servere
description: talon integreres med LSP-serverne dine.
---
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `TALON_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og talon åpner en fil, gjør den:
