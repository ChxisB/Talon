---
title: TUI
description: Bruke talon-terminalbrukergrensesnittet.
---
...
Dette er atskilt fra `talon.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `TALON_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `talon.default`.
