...
Konfigurer agenter i konfigurasjonsfilen `talon.json`:
...
- Globalt: `~/.config/talon/agents/`
- Per prosjekt: `.talon/agents/`
...
Modellen ID i OpenCode-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [OpenCode Zen](/docs/zen), vil du bruke `talon/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Kjør `talon models` for å se en liste over tilgjengelige modeller.
:::
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/ChxisB/Talon).
:::
