...
- `.talon/plugins/` - Programtillegg på prosjektnivå
...
**npm-plugins** installeres automatisk ved hjelp av Bun ved oppstart. Pakker og deres avhengigheter er bufret i `~/.cache/talon/node_modules/`.
...
1. Global konfigurasjon (`~/.config/talon/talon.json`)
2. Prosjektkonfigurasjon (`talon.json`)
3. Global plugin-katalog (`~/.config/talon/plugins/`)
4. Prosjektpluginkatalog (`.talon/plugins/`)
...
Nivåer: `debug`, `info`, `warn`, `error`. Se [SDK dokumentasjon](https://talon.ai/docs/sdk) for detaljer.
