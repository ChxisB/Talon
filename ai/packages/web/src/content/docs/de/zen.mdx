...
Die [Model-ID](/docs/config/#models) in deiner OpenCode-Konfiguration verwendet das Format `talon/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `talon/gpt-5.5` in deiner Konfiguration verwenden.
