...
Standardmaessig verwendet OpenCode das `talon`-Theme.
...
2. **Benutzer-Config-Verzeichnis** - Definiert in `~/.config/talon/themes/*.json` oder `$XDG_CONFIG_HOME/talon/themes/*.json`
3. **Projekt-Root-Verzeichnis** - Definiert in `<project-root>/.talon/themes/*.json`
4. **Aktuelles Arbeitsverzeichnis** - Definiert in `./.talon/themes/*.json`
