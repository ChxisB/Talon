...
![OpenCode TUI with the talon theme](../../../assets/lander/screenshot.png)
...
- **Homebrew unter macOS und Linux verwenden**
  ...
  > Wir empfehlen die Verwendung des OpenCode-Taps für die aktuellsten Versionen. Die offizielle `brew install talon`-Formel wird vom Homebrew-Team gepflegt und seltener aktualisiert.
...
Sie können die Binärdatei auch aus [Releases](https://github.com/ChxisB/Talon/releases) abrufen.
...
Hier ist ein [Beispielgespräch](https://talon.ai/s/4XP1fce5) mit OpenCode.
