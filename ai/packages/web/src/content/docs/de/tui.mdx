...
Dies ist getrennt von `talon.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `TALON_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
...
- `sound_pack` - Zu verwendende sound pack ID. Standard ist `talon.default`.
