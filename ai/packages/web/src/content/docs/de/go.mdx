...
Die [Modell-ID](/docs/config/#models) in deiner OpenCode Config verwendet das Format `talon-go/<model-id>`. Für Kimi K2.7 Code würdest du beispielsweise `talon-go/kimi-k2.7-code` in deiner Config verwenden.
