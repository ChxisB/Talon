...
Here we are using a community-created CI/CD component for OpenCode — [nagyv/gitlab-talon](https://gitlab.com/nagyv/gitlab-talon).
...
For more inputs and use cases [check out the docs](https://gitlab.com/explore/catalog/nagyv/gitlab-talon) for this component.
...
Mention `@talon` in a comment, and OpenCode will execute tasks within your GitLab CI pipeline.
...
:::tip
You can configure to use a different trigger phrase than `@talon`.
:::
