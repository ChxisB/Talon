...
Skonfiguruj agenta w pliku `talon.json`:
...
- Globalnie: `~/.config/talon/agents/`
- W projekcie: `.talon/agents/`
...
Identyfikator modelu jest taki sam, jak w konfiguracji OpenCode w `provider/model-id`. Na przykład, [OpenCode Zen](/docs/zen), użyj `talon/gpt-5.1-codex` dla GPT 5.1 Codex.
...
:::tip
Uruchom `talon models`, aby zobaczyć dostępne modele.
:::
...
:::tip
Masz agenta, którym warto się podzielić? [Prześlij PR](https://github.com/ChxisB/Talon).
:::
