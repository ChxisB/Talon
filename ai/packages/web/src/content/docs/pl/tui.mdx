---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala talon.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

talon zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie talon uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI talon, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do talon. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `talon.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `TALON_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `talon.default`.
