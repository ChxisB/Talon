...
Możesz zdefiniować polecenia w `talon.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji talon:
...
- Globalnie: `~/.config/talon/commands/`
- Na projekt: `.talon/commands/`
...
talon zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
