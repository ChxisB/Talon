...
To use OpenCode via ACP, configure your editor to run the `talon acp` command.
...
If you need to pass environment variables (like `TALON_API_KEY`), refer to [Configuring Adapters: Environment Variables](https://codecompanion.olimorris.dev/getting-started#setting-an-api-key) in the CodeCompanion.nvim documentation for full details.
