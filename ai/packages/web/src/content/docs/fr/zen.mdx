...
Le [model id](/docs/config/#models) dans votre configuration OpenCode utilise le format `talon/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `talon/gpt-5.5` dans votre configuration.
