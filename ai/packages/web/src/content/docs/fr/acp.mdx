...
Pour utiliser OpenCode via ACP, configurez votre éditeur pour exécuter la commande `talon acp`.
...
Si vous devez transmettre des variables d'environnement (comme `TALON_API_KEY`), reportez-vous à [Configuring Adapters: Environment Variables](https://codecompanion.olimorris.dev/getting-started#setting-an-api-key) dans la documentation CodeCompanion.nvim pour plus de détails.
