...
- Configuration du projet : `.talon/skills/<name>/SKILL.md`
- Configuration globale : `~/.config/talon/skills/<name>/SKILL.md`
...
Il charge tout `skills/*/SKILL.md` correspondant dans `.talon/` et tout `.claude/skills/*/SKILL.md` ou `.agents/skills/*/SKILL.md` correspondant en cours de route.

Les définitions globales sont également chargées à partir de `~/.config/talon/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` et `~/.agents/skills/*/SKILL.md`.
...
Créez `.talon/skills/git-release/SKILL.md` comme ceci :
...
Contrôlez les compétences auxquelles les agents peuvent accéder à l'aide d'autorisations basées sur des modèles dans `talon.json` :
...
**Pour les agents intégrés** (dans `talon.json`) :
