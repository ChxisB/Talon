...
Ceci est séparé de `talon.json`, qui configure le comportement du serveur/d'exécution.
...
Utilisez `TALON_TUI_CONFIG` pour charger un chemin de configuration TUI personnalisé.
...
- `sound_pack` - ID du sound pack à utiliser. Valeur par défaut : `talon.default`.
