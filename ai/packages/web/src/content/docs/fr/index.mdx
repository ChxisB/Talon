...
![OpenCode TUI avec le thème talon](../../../assets/lander/screenshot.png)
...
- **Via Homebrew sur macOS et Linux**
  ...
  > Nous vous recommandons d'utiliser le tap OpenCode pour les versions les plus récentes. La formule officielle `brew install talon` est maintenue par l'équipe Homebrew et est mise à jour moins fréquemment.
...
Vous pouvez également récupérer le binaire dans les [Releases](https://github.com/ChxisB/Talon/releases).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez talon et allez sur [talon.ai/auth](https://talon.ai/auth).
...
Voici un [exemple de conversation](https://talon.ai/s/4XP1fce5) avec OpenCode.
