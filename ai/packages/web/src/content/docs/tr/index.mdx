...
![talon TUI with the talon theme](../../../assets/lander/screenshot.png)
...
- **Homebrew'u macOS ve Linux'ta kullanma**
  ...
  > En güncel sürümler için OpenCode tap'ini kullanmanızı öneririz. Resmi `brew install talon` formülü Homebrew ekibi tarafından korunur ve daha sık güncellenir.
...
İkili dosyayı [Releases](https://github.com/ChxisB/Talon/releases)'dan da alabilirsiniz.
...
İşte OpenCode ile bir [örnek konuşma](https://talon.ai/s/4XP1fce5).
