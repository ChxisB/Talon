...
description: talon dile özgü biçimlendiriciler kullanır.
---

talon, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

talon, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, talon bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

talon bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri talon yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
