...
OpenCode yapılandırmanızdaki [model id](/docs/config/#models) formatı `talon-go/<model-id>` şeklindedir. Örneğin, Kimi K2.7 Code için yapılandırmanızda `talon-go/kimi-k2.7-code` kullanmalısınız.
