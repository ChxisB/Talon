---
title: Paylasim
description: talon konusmalarini genel baglantilarla paylasin.
---

talon'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda talon:
...
talon, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak talon manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `talon.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda talon kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
