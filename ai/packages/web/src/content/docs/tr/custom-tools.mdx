---
title: Özel Araçlar
description: LLM'un talon'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. talon'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.talon/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/talon/tools/` içine yerleştirerek.
