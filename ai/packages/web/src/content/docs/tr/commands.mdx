...
`.talon/commands/test.md` oluştur:
...
talon işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

talon [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/talon/commands/`
- Proje başına: `.talon/commands/`
...
talon, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
