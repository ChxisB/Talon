...
Konfigurirajte agente u svom konfiguracijskom fajlu `talon.json`:
...
- Globalno: `~/.config/talon/agents/`
- Po projektu: `.talon/agents/`
...
ID modela u vašoj OpenCode konfiguraciji koristi format `provider/model-id`. Na primjer, ako koristite [OpenCode Zen](/docs/zen), koristili biste `talon/gpt-5.1-codex` za GPT 5.1 Codex.
...
:::tip
Pokrenite `talon models` da vidite listu dostupnih modela.
:::
...
:::tip
Imate li agenta kojeg biste željeli podijeliti? [Pošalji PR](https://github.com/ChxisB/Talon).
:::
