...
- Konfiguracija projekta: `.talon/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/talon/skills/<name>/SKILL.md`
...
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.talon/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/talon/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.talon/skills/git-release/SKILL.md` ovako:
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `talon.json`:
...
**Za ugradene agente** (u `talon.json`):
