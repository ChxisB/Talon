...
![OpenCode TUI sa talon temom](../../../assets/lander/screenshot.png)
Hajde da počnemo.
...
> Preporučujemo korištenje OpenCode tap za najnovija izdanja. Službenu formulu `brew install talon` održava Homebrew tim i ažurira se rjeđe.
...
Također možete preuzeti binarnu datoteku iz [Releases](https://github.com/ChxisB/Talon/releases).
...
:::
Evo [primjer razgovora](https://talon.ai/s/4XP1fce5) sa OpenCode.
