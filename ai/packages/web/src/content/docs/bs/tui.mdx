...
Ovo je odvojeno od `talon.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `TALON_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `talon.default`.
