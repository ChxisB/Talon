...
OpenCode se integriše sa VS kodom, Cursor-om ili bilo kojim IDE-om koji podržava terminal. Samo pokrenite `talon` u terminalu da započnete.
...
3. Pokrenite `talon` - ekstenzija se automatski instalira
...
- Uvjerite se da koristite `talon` u integriranom terminalu.
