...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `TALON_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i talon otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj talon konfiguraciji.
