...
Ovdje koristimo CI/CD komponentu kreiranu u zajednici za OpenCode — [nagyv/gitlab-talon](https://gitlab.com/nagyv/gitlab-talon).
...
Za više unosa i slučajeva upotrebe [pogledajte dokumente docs](https://gitlab.com/explore/catalog/nagyv/gitlab-talon) za ovu komponentu.
...
Spomenite `@talon` u komentaru i OpenCode će izvršiti zadatke unutar vašeg GitLab CI cevovoda.
...
:::tip
Možete konfigurirati da koristite drugu frazu okidača od `@talon`.
:::
