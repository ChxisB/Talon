...
To enforce this across your team for a given project, add it to the `talon.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using talon in your organization.
