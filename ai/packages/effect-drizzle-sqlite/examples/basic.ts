...
class Database extends Context.Service<Database, DatabaseShape>()("@talon/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@talon/example/UserStore") {
