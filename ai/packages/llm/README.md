...
Schema-first LLM core for talon. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@talon-ai/llm"
import { OpenAI } from "@talon-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@talon-ai/llm/providers"
