...
export const dict = {
  ...
  "notFound.title": "Non trovato | talon",
  "notFound.heading": "404 - Pagina non trovata",
  "notFound.home": "Home",
  "notFound.docs": "Documentazione",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "logo chiaro di talon",
  "notFound.logoDarkAlt": "logo scuro di talon",
  ...
  "temp.title": "talon | Agente di coding IA costruito per il terminale",
  ...
  "temp.feature.zen.afterLink": "fornita da talon",
  ...
  "temp.logoLightAlt": "logo chiaro di talon",
  "temp.logoDarkAlt": "logo scuro di talon",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con qualsiasi agente di coding, e continua a usare altri provider con talon quando vuoi.",
  ...
  "workspace.newUser.step.login.after": "e seleziona talon",
  "workspace.newUser.step.pasteKey": "Incolla la tua chiave API",
  "workspace.newUser.step.models.before": "Avvia talon ed esegui",
  ...
  "workspace.keys.subtitle": "Gestisci le tue chiavi API per accedere ai servizi talon.",
  "workspace.keys.create": "Crea Chiave API",
  "workspace.keys.placeholder": "Inserisci nome chiave",
  "workspace.keys.empty": "Crea una chiave API talon Gateway",
  ...
  "workspace.lite.subscription.selectProvider":
    'Seleziona "OpenCode Go" come provider nella tua configurazione talon per utilizzare i modelli Go.',
