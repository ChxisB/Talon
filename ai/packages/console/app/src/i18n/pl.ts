...
export const dict = {
  ...
  "notFound.title": "Nie znaleziono | talon",
  "notFound.heading": "404 - Nie znaleziono strony",
  "notFound.home": "Strona główna",
  "notFound.docs": "Dokumentacja",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "jasne logo talon",
  "notFound.logoDarkAlt": "ciemne logo talon",
  ...
  "temp.title": "talon | Agent AI do kodowania zbudowany dla terminala",
  ...
  "temp.feature.zen.afterLink": "dostarczana przez talon",
  ...
  "temp.logoLightAlt": "jasne logo talon",
  "temp.logoDarkAlt": "ciemne logo talon",
  ...
  "workspace.newUser.step.login.after": "i wybierz talon",
  "workspace.newUser.step.pasteKey": "Wklej swój klucz API",
  "workspace.newUser.step.models.before": "Uruchom talon i wpisz",
  ...
  "workspace.keys.subtitle": "Zarządzaj kluczami API do usług talon.",
  "workspace.keys.create": "Utwórz klucz API",
  "workspace.keys.placeholder": "Wpisz nazwę klucza",
  "workspace.keys.empty": "Utwórz klucz API bramy talon",
  ...
  "workspace.lite.subscription.selectProvider":
    'Wybierz "OpenCode Go" jako dostawcę w konfiguracji talon, aby używać modeli Go.',
