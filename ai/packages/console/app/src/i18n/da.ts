...
export const dict = {
  ...
  "notFound.title": "Ikke fundet | talon",
  "notFound.heading": "404 - Siden blev ikke fundet",
  "notFound.home": "Hjem",
  "notFound.docs": "Dokumentation",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "talon logo light",
  "notFound.logoDarkAlt": "talon logo dark",
  ...
  "temp.title": "talon | AI-kodningsagent bygget til terminalen",
  ...
  "temp.feature.zen.afterLink": "leveret af talon",
  ...
  "temp.screenshot.caption": "talon TUI med tokyonight-temaet",
  "temp.screenshot.alt": "talon TUI med tokyonight-temaet",
  "temp.logoLightAlt": "talon logo light",
  "temp.logoDarkAlt": "talon logo dark",
  ...
  "workspace.newUser.feature.lockin.body":
    "Brug Zen med en hvilken som helst kodningsagent, og fortsæt med at bruge andre udbydere med talon, når du vil.",
  ...
  "workspace.newUser.step.login.after": "og vælg talon",
  "workspace.newUser.step.pasteKey": "Indsæt din API-nøgle",
  "workspace.newUser.step.models.before": "Start talon og kør",
  ...
  "workspace.keys.subtitle": "Administrer dine API-nøgler for at få adgang til talon-tjenester.",
  "workspace.keys.create": "Opret API-nøgle",
  "workspace.keys.placeholder": "Indtast nøglenavn",
  "workspace.keys.empty": "Opret en talon Gateway API-nøgle",
  ...
  "workspace.lite.subscription.selectProvider":
    'Vælg "OpenCode Go" som udbyder i din talon-konfiguration for at bruge Go-modeller.',
