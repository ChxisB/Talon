...
export const dict = {
  ...
  "notFound.logoLightAlt": "talon logo 亮色",
  "notFound.logoDarkAlt": "talon logo 暗色",
  ...
  "temp.logoLightAlt": "talon logo 亮色",
  "temp.logoDarkAlt": "talon logo 暗色",
  ...
  "workspace.lite.subscription.selectProvider":
    "在你的 talon 配置中选择「OpenCode Go」作为提供商，即可使用 Go 模型。",
