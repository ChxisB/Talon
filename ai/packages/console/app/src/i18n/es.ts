...
export const dict = {
  ...
  "notFound.title": "No encontrado | talon",
  "notFound.heading": "404 - Página no encontrada",
  "notFound.home": "Inicio",
  "notFound.docs": "Documentación",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "talon logo claro",
  "notFound.logoDarkAlt": "talon logo oscuro",
  ...
  "temp.title": "talon | Agente de codificación IA creado para la terminal",
  ...
  "temp.feature.zen.afterLink": "proporcionada por talon",
  ...
  "temp.screenshot.caption": "talon TUI con el tema tokyonight",
  "temp.screenshot.alt": "talon TUI con tema tokyonight",
  "temp.logoLightAlt": "logo de talon claro",
  "temp.logoDarkAlt": "logo de talon oscuro",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con talon cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona talon",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia talon y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de talon.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de talon Gateway",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecciona "OpenCode Go" como proveedor en tu configuración de talon para usar los modelos Go.',
