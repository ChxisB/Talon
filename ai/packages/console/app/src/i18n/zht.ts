...
export const dict = {
  ...
  "notFound.logoLightAlt": "talon 淺色標誌",
  "notFound.logoDarkAlt": "talon 深色標誌",
  ...
  "temp.logoLightAlt": "talon 淺色標誌",
  "temp.logoDarkAlt": "talon 深色標誌",
  ...
  "workspace.lite.subscription.selectProvider":
    "在您的 talon 設定中選擇「OpenCode Go」作為提供商，即可使用 Go 模型。",
