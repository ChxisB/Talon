...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | talon",
  "notFound.heading": "404 - Side ikke funnet",
  "notFound.home": "Hjem",
  "notFound.docs": "Dokumentasjon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "talon logo lys",
  "notFound.logoDarkAlt": "talon logo mørk",
  ...
  "temp.title": "talon | AI-kodingsagent bygget for terminalen",
  ...
  "temp.feature.zen.afterLink": "levert av talon",
  ...
  "temp.screenshot.caption": "talon TUI med tokyonight-tema",
  "temp.screenshot.alt": "talon TUI med tokyonight-tema",
  "temp.logoLightAlt": "talon logo lys",
  "temp.logoDarkAlt": "talon logo mørk",
  ...
  "workspace.newUser.feature.lockin.body":
    "Bruk Zen med hvilken som helst kodeagent, og fortsett å bruke andre leverandører med talon når du vil.",
  ...
  "workspace.newUser.step.login.after": "og velg talon",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start talon og kjør",
  ...
  "workspace.keys.subtitle": "Administrer API-nøklene dine for å få tilgang til talon-tjenester.",
  "workspace.keys.create": "Opprett API-nøkkel",
  "workspace.keys.placeholder": "Skriv inn navn på nøkkel",
  "workspace.keys.empty": "Opprett en talon Gateway API-nøkkel",
  ...
  "workspace.lite.subscription.selectProvider":
    'Velg "OpenCode Go" som leverandør i talon-konfigurasjonen din for å bruke Go-modeller.',
