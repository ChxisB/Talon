...
export const dict = {
  ...
  "notFound.title": "Не знайдено | talon",
  "notFound.heading": "404 — Сторінку не знайдено",
  "notFound.home": "Головна",
  "notFound.docs": "Документація",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "світлий логотип talon",
  "notFound.logoDarkAlt": "темний логотип talon",
  ...
  "temp.title": "talon | AI-агент для кодування, створений для термінала",
  ...
  "temp.feature.zen.afterLink": "від talon",
  ...
  "temp.logoLightAlt": "світлий логотип talon",
  "temp.logoDarkAlt": "темний логотип talon",
  ...
  "workspace.newUser.step.login.after": "і виберіть talon",
  "workspace.newUser.step.pasteKey": "Вставте ключ API",
  "workspace.newUser.step.models.before": "Запустіть talon і виконайте",
  ...
  "workspace.keys.subtitle": "Керуйте ключами API для доступу до сервісів talon.",
  "workspace.keys.create": "Створити ключ API",
  "workspace.keys.placeholder": "Введіть назву ключа",
  "workspace.keys.empty": "Створіть ключ API шлюзу talon",
  ...
  "workspace.lite.subscription.selectProvider": 'Виберіть "OpenCode Go" як провайдера в конфігурації talon.',
