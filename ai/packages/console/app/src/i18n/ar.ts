...
export const dict = {
  ...
  "notFound.title": "غير موجود | talon",
  "notFound.heading": "404 - الصفحة غير موجودة",
  "notFound.home": "الرئيسية",
  "notFound.docs": "الوثائق",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "شعار talon الفاتح",
  "notFound.logoDarkAlt": "شعار talon الداكن",
  ...
  "temp.title": "talon | وكيل برمجة بالذكاء الاصطناعي مبني للطرفية",
  ...
  "temp.feature.zen.afterLink": "مقدمة من talon",
  ...
  "temp.logoLightAlt": "شعار talon الفاتح",
  "temp.logoDarkAlt": "شعار talon الداكن",
  ...
  "workspace.newUser.feature.lockin.body":
    "استخدم Zen مع أي وكيل برمجة، واستمر في استخدام موفرين آخرين مع talon وقتما تشاء.",
  ...
  "workspace.newUser.step.login.after": "واختر talon",
  "workspace.newUser.step.pasteKey": "الصق مفتاح API الخاص بك",
  "workspace.newUser.step.models.before": "ابدأ talon ثم نفّذ",
  ...
  "workspace.keys.subtitle": "إدارة مفاتيح API الخاصة بك للوصول إلى خدمات talon.",
  "workspace.keys.create": "إنشاء مفتاح API",
  "workspace.keys.placeholder": "أدخل اسم المفتاح",
  "workspace.keys.empty": "أنشئ مفتاح API لبوابة talon",
  ...
  "workspace.lite.subscription.selectProvider":
    'اختر "OpenCode Go" كمزود في إعدادات talon الخاصة بك لاستخدام نماذج Go.',
