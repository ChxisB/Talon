...
export const dict = {
  ...
  "notFound.logoLightAlt": "talon 밝은 로고",
  "notFound.logoDarkAlt": "talon 어두운 로고",
  ...
  "temp.logoLightAlt": "talon 밝은 로고",
  "temp.logoDarkAlt": "talon 어두운 로고",
  ...
  "workspace.lite.subscription.selectProvider":
    'Go 모델을 사용하려면 talon 설정에서 "OpenCode Go"를 공급자로 선택하세요.',
