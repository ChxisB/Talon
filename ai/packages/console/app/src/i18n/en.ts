export const dict = {
  ...
  "notFound.title": "Not Found | talon",
  ...
  "temp.title": "talon | AI coding agent built for the terminal",
  ...
  "temp.feature.zen.afterLink": "provided by talon",
  "temp.feature.models.beforeLink": "Supports 75+ LLM providers through",
  "temp.feature.models.afterLink": ", including local models",
  "temp.screenshot.caption": "talon TUI with the tokyonight theme",
  "temp.screenshot.alt": "talon TUI with tokyonight theme",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use Zen with any coding agent, and continue using other providers with talon whenever you want.",
  ...
  "workspace.newUser.step.login.after": "and select talon",
  "workspace.newUser.step.pasteKey": "Paste your API key",
  "workspace.newUser.step.models.before": "Start talon and run",
  ...
  "workspace.keys.subtitle": "Manage your API keys for accessing talon services.",
  "workspace.keys.create": "Create API Key",
  "workspace.keys.placeholder": "Enter key name",
  "workspace.keys.empty": "Create an talon Gateway API key",
  ...
  "workspace.lite.subscription.selectProvider":
    'Select "OpenCode Go" as the provider in your talon configuration to use Go models.',
