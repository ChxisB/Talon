...
export const dict = {
  ...
  "notFound.logoLightAlt": "talonのロゴ（ライト）",
  "notFound.logoDarkAlt": "talonのロゴ（ダーク）",
  ...
  "temp.logoLightAlt": "talonのロゴ（ライト）",
  "temp.logoDarkAlt": "talonのロゴ（ダーク）",
  ...
  "workspace.lite.subscription.selectProvider":
    "Go モデルを使用するには、talon の設定で「OpenCode Go」をプロバイダーとして選択してください。",
