...
export const dict = {
  ...
  "notFound.title": "Não encontrado | talon",
  "notFound.heading": "404 - Página não encontrada",
  "notFound.home": "Início",
  "notFound.docs": "Documentação",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "logo talon claro",
  "notFound.logoDarkAlt": "logo talon escuro",
  ...
  "temp.title": "talon | Agente de codificação com IA feito para o terminal",
  ...
  "temp.feature.zen.afterLink": "fornecida pela talon",
  ...
  "temp.logoLightAlt": "logo talon claro",
  "temp.logoDarkAlt": "logo talon escuro",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use o Zen com qualquer agente de codificação e continue usando outros provedores com talon sempre que quiser.",
  ...
  "workspace.newUser.step.login.after": "e selecione talon",
  "workspace.newUser.step.pasteKey": "Cole sua chave de API",
  "workspace.newUser.step.models.before": "Inicie o talon e execute",
  ...
  "workspace.keys.subtitle": "Gerencie suas chaves de API para acessar os serviços talon.",
  "workspace.keys.create": "Criar Chave de API",
  "workspace.keys.placeholder": "Digite o nome da chave",
  "workspace.keys.empty": "Crie uma chave de API do talon Gateway",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecione "OpenCode Go" como provedor na sua configuração do talon para usar os modelos Go.',
