...
export const dict = {
  ...
  "notFound.title": "Bulunamadı | talon",
  "notFound.heading": "404 - Sayfa bulunamadı",
  "notFound.home": "Ana sayfa",
  "notFound.docs": "Dokümantasyon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "talon açık logo",
  "notFound.logoDarkAlt": "talon koyu logo",
  ...
  "temp.title": "talon | Terminal için geliştirilmiş yapay zeka kodlama ajanı",
  ...
  "temp.feature.zen.beforeLink": "talon tarafından sağlanan ",
  ...
  "temp.screenshot.caption": "talon TUI ve tokyonight teması",
  "temp.screenshot.alt": "tokyonight temalı talon TUI",
  "temp.logoLightAlt": "talon açık logo",
  "temp.logoDarkAlt": "talon koyu logo",
  ...
  "workspace.newUser.feature.lockin.body":
    "Zen'i herhangi bir kodlama ajanıyla kullanın ve istediğiniz zaman talon ile diğer sağlayıcıları kullanmaya devam edin.",
  ...
  "workspace.newUser.step.login.after": "ve talon seçeneğini seçin",
  "workspace.newUser.step.pasteKey": "API anahtarınızı yapıştırın",
  "workspace.newUser.step.models.before": "talon'u başlatın ve çalıştırın",
  ...
  "workspace.keys.subtitle": "talon hizmetlerine erişim için API anahtarlarınızı yönetin.",
  "workspace.keys.create": "API Anahtarı Oluştur",
  "workspace.keys.placeholder": "Anahtar adını girin",
  "workspace.keys.empty": "Bir talon Gateway API anahtarı oluşturun",
  ...
  "workspace.lite.subscription.selectProvider":
    'Go modellerini kullanmak için talon yapılandırmanızda "OpenCode Go"\'yu sağlayıcı olarak seçin.',
