...
export const dict = {
  ...
  "notFound.title": "Не найдено | talon",
  "notFound.heading": "404 - Страница не найдена",
  "notFound.home": "Главная",
  "notFound.docs": "Документация",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "светлый логотип talon",
  "notFound.logoDarkAlt": "темный логотип talon",
  ...
  "temp.title": "talon | AI-агент для программирования в терминале",
  ...
  "temp.feature.zen.afterLink": "от talon",
  ...
  "temp.logoLightAlt": "светлый логотип talon",
  "temp.logoDarkAlt": "темный логотип talon",
  ...
  "workspace.newUser.feature.lockin.body":
    "Используйте Zen с любым кодинг-агентом и продолжайте использовать других провайдеров с talon, когда захотите.",
  ...
  "workspace.newUser.step.login.after": "и выберите talon",
  "workspace.newUser.step.pasteKey": "Вставьте ваш API ключ",
  "workspace.newUser.step.models.before": "Запустите talon и выполните",
  ...
  "workspace.keys.subtitle": "Управляйте вашими API ключами для доступа к сервисам talon.",
  "workspace.keys.create": "Создать API ключ",
  "workspace.keys.placeholder": "Введите название ключа",
  "workspace.keys.empty": "Создайте API ключ для шлюза talon",
  ...
  "workspace.lite.subscription.selectProvider":
    'Выберите "OpenCode Go" в качестве провайдера в настройках talon для использования моделей Go.',
