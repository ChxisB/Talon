          ...
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://talon.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-talon">What is OpenCode?</h2>
              <p>
              ...
              <p>
                ...
                our site located at talon.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                ...
                click here{" "}
                <a href="https://talon.ai/legal/privacy-policy">https://talon.ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="will-talon-ever-change-the-services">Will OpenCode ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://talon.ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://talon.ai/auth">https://talon.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://talon.ai/legal/privacy-policy</a>, as well
