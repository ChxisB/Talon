...
import compareVideo from "../../asset/lander/talon-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/talon-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="talon:auth" content={loggedin() ? "true" : "false"} />
