...
import { and, Database, eq, isNull, lt, or, sql } from "@talon-ai/console-core/drizzle/index.js"
import { KeyTable } from "@talon-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@talon-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@talon-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@talon-ai/console-core/util/date.js"
import { Identifier } from "@talon-ai/console-core/identifier.js"
import { Billing } from "@talon-ai/console-core/billing.js"
import { Actor } from "@talon-ai/console-core/actor.js"
import { WorkspaceTable } from "@talon-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@talon-ai/console-core/model.js"
import { Subscription } from "@talon-ai/console-core/subscription.js"
import { BlackData } from "@talon-ai/console-core/black.js"
import { UserTable } from "@talon-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@talon-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@talon-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@talon-ai/console-core/lite.js"
import { Resource } from "@talon-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-talon-session") ?? ""
    const requestId = input.request.headers.get("x-talon-request") ?? ""
    const ocClient = input.request.headers.get("x-talon-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-talon-request")
          headers.delete("x-talon-session")
          headers.delete("x-talon-project")
          headers.delete("x-talon-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://talon.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://talon.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://talon.ai/workspace/${authInfo.workspaceID}/members`
