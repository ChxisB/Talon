...
import desktopAppIcon from "../../asset/lander/talon-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://talon.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>talon.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g talon-ai")}>
                <code>
                  npm i -g <strong>talon-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g talon-ai")}>
                <code>
                  bun add -g <strong>talon-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/talon")}>
                <code>
                  brew install <strong>anomalyco/tap/talon</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S talon")}>
                <code>
                  paru -S <strong>talon</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask talon-desktop")}>
                <code>
                  brew install --cask <strong>talon-desktop</strong>
                </code>
                <CopyStatus />
              </button>
