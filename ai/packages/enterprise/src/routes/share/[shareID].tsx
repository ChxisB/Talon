import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@talon-ai/sdk/v2"
import { SessionTurn } from "@talon-ai/ui/session-turn"
import { SessionReview } from "@talon-ai/ui/session-review"
import { DataProvider } from "@talon-ai/ui/context"
import { FileComponentProvider } from "@talon-ai/ui/context/file"
import { WorkerPoolProvider } from "@talon-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@talon-ai/ui/logo"
import { IconButton } from "@talon-ai/ui/icon-button"
import { ProviderIcon } from "@talon-ai/ui/provider-icon"
import { iife } from "@talon-ai/core/util/iife"
import { Binary } from "@talon-ai/core/util/binary"
import { NamedError } from "@talon-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@talon-ai/ui/tabs"
import { MessageNav } from "@talon-ai/ui/message-nav"
import { FileSSR } from "@talon-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@talon-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/talon-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })
          ...
          return (
            <>
              ...
              <Meta name="description" content="talon - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/ChxisB/Talon"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
