export const dict = {
  ...
  "dialog.provider.talon.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.talon.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.talonGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "provider.connect.talonZen.visit.prefix": "قم بزيارة ",
  "provider.connect.talonZen.visit.link": "talon.ai/zen",
  "provider.connect.talonZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في talon.json",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (talon.json)",
