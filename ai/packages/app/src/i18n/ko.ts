export const dict = {
  ...
  "dialog.provider.talon.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.talon.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.talonGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "provider.connect.talonZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.talonZen.visit.prefix": "다음 ",
  "provider.connect.talonZen.visit.link": "talon.ai/zen",
  "provider.connect.talonZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  ...
  "dialog.plugins.empty": "talon.json에 구성된 플러그인",
  ...
  "error.chain.checkConfig": "구성(talon.json)의 공급자/모델 이름을 확인하세요",
