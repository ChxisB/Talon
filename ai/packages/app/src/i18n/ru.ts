export const dict = {
  ...
  "dialog.provider.talon.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.talon.tagline": "Надежные оптимизированные модели",
  "dialog.provider.talonGo.tagline": "Доступная подписка для всех",
  ...
  "provider.connect.talonZen.visit.prefix": "Посетите ",
  "provider.connect.talonZen.visit.link": "talon.ai/zen",
  "provider.connect.talonZen.visit.suffix": " чтобы получить ваш API ключ.",
  ...
  "dialog.plugins.empty": "Плагины настроены в talon.json",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (talon.json)",
