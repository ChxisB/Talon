export const dict = {
  ...
  "dialog.provider.talon.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.talon.tagline": "Modelos optimizados y fiables",
  "dialog.provider.talonGo.tagline": "Suscripción económica para todos",
  ...
  "provider.connect.talonZen.visit.prefix": "Visita ",
  "provider.connect.talonZen.visit.link": "talon.ai/zen",
  "provider.connect.talonZen.visit.suffix": " para obtener tu clave API.",
  ...
  "dialog.plugins.empty": "Plugins configurados en talon.json",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (talon.json)",
