export const dict = {
  ...
  "dialog.provider.talon.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.talon.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.talonGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "provider.connect.talonZen.visit.prefix": "Odwiedź ",
  "provider.connect.talonZen.visit.link": "talon.ai/zen",
  "provider.connect.talonZen.visit.suffix": ", aby odebrać swój klucz API.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w talon.json",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (talon.json) nazwy dostawców/modeli",
