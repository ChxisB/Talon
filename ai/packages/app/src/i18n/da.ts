export const dict = {
  ...
  "dialog.provider.talon.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.talon.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.talonGo.tagline": "Billigt abonnement for alle",
  ...
  "provider.connect.talonZen.visit.prefix": "Besøg ",
  "provider.connect.talonZen.visit.link": "talon.ai/zen",
  "provider.connect.talonZen.visit.suffix": " for at hente din API-nøgle.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i talon.json",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (talon.json) udbyder/modelnavne",
