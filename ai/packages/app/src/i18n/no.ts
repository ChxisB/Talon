...
export const dict = {
  ...
  "dialog.provider.talon.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.talon.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.talonGo.tagline": "Rimelig abonnement for alle",
  ...
  "provider.connect.talonZen.visit.prefix": "Besøk ",
  "provider.connect.talonZen.visit.link": "talon.ai/zen",
  "provider.connect.talonZen.visit.suffix": " for å hente API-nøkkelen din.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i talon.json",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (talon.json)",
