...
export const dict = {
  ...
  "dialog.provider.talon.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.talon.tagline": "可靠的優化模型",
  "dialog.provider.talonGo.tagline": "適合所有人的低成本訂閱",
  ...
  "provider.connect.talonZen.line1": "OpenCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.talonZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.talonZen.visit.prefix": "造訪 ",
  "provider.connect.talonZen.visit.link": "talon.ai/zen",
  "provider.connect.talonZen.visit.suffix": " 取得你的 API 金鑰。",
  ...
  "dialog.plugins.empty": "在 talon.json 中設定的外掛程式",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (talon.json) 中的 provider/model 名稱",
