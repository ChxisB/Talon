export const dict = {
  ...
  "dialog.provider.talon.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.talon.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.talonGo.tagline": "Недорога підписка для всіх",
  ...
  "provider.connect.talonZen.visit.prefix": "Відвідайте ",
  "provider.connect.talonZen.visit.link": "talon.ai/zen",
  "provider.connect.talonZen.visit.suffix": ", щоб отримати ключ API.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в talon.json",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (talon.json)",
