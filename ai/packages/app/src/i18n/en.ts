export const dict = {
  ...
  "dialog.provider.talon.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.talon.tagline": "Reliable optimized models",
  "dialog.provider.talonGo.tagline": "Low cost subscription for everyone",
  ...
  "provider.connect.talonZen.line1":
    "OpenCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.talonZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.talonZen.visit.prefix": "Visit ",
  "provider.connect.talonZen.visit.link": "talon.ai/zen",
  "provider.connect.talonZen.visit.suffix": " to collect your API key.",
  ...
  "dialog.plugins.empty": "Plugins configured in talon.json",
  ...
  "wsl.onboarding.step.talon": "OpenCode",
  ...
  "wsl.onboarding.talonReadyIn": "OpenCode is ready in {{distro}}.",
  "wsl.onboarding.talonReady": "OpenCode is ready.",
  ...
  "error.chain.checkConfig": "Check your config (talon.json) provider/model names",
