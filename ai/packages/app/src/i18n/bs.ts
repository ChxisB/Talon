export const dict = {
  ...
  "dialog.provider.talon.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.talon.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.talonGo.tagline": "Povoljna pretplata za sve",
  ...
  "provider.connect.talonZen.visit.prefix": "Posjeti ",
  "provider.connect.talonZen.visit.link": "talon.ai/zen",
  "provider.connect.talonZen.visit.suffix": " da preuzmeš svoj API ključ.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u talon.json",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (talon.json) provider/model names",
