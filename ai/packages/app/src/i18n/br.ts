export const dict = {
  ...
  "dialog.provider.talon.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.talon.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.talonGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "provider.connect.talonZen.visit.prefix": "Visite ",
  "provider.connect.talonZen.visit.link": "talon.ai/zen",
  "provider.connect.talonZen.visit.suffix": " para obter sua chave de API.",
  ...
  "dialog.plugins.empty": "Plugins configurados em talon.json",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (talon.json)",
