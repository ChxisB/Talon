...
export const dict = {
  ...
  "dialog.provider.talon.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.talon.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.talonGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "provider.connect.talonZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.talonZen.visit.link": "talon.ai/zen",
  "provider.connect.talonZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  ...
  "dialog.plugins.empty": "In talon.json konfigurierte Plugins",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (talon.json) auf Anbieter-/Modellnamen",
