export const dict = {
  ...
  "dialog.provider.talon.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.talon.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.talonGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "provider.connect.talonZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.talonZen.visit.prefix": " ",
  "provider.connect.talonZen.visit.link": "talon.ai/zen",
  "provider.connect.talonZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  ...
  "dialog.plugins.empty": "talon.jsonで設定されたプラグイン",
  ...
  "error.chain.checkConfig": "config (talon.json) のプロバイダー/モデル名を確認してください",
