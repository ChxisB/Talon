export const dict = {
  ...
  "dialog.provider.talon.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.talon.tagline": "Modèles optimisés et fiables",
  "dialog.provider.talonGo.tagline": "Abonnement abordable pour tous",
  ...
  "provider.connect.talonZen.visit.prefix": "Visitez ",
  "provider.connect.talonZen.visit.link": "talon.ai/zen",
  "provider.connect.talonZen.visit.suffix": " pour récupérer votre clé API.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans talon.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (talon.json) pour les noms de fournisseur/modèle",
