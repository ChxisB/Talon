...
export const dict = {
  ...
  "dialog.provider.talon.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.talon.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.talonGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "provider.connect.talonZen.visit.prefix": "",
  "provider.connect.talonZen.visit.link": "talon.ai/zen",
  "provider.connect.talonZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "dialog.plugins.empty": "Eklentiler talon.json içinde yapılandırılır",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (talon.json) sağlayıcı/model adlarını kontrol edin",
