...
beforeAll(async () => {
  ...
  mock.module("@talon-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@talon-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@talon-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@talon-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
