...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "talon", key: "dialog.provider.talon.note" },
  { match: (id: string) => id === "talon-go", key: "dialog.provider.talonGo.tagline" },
...
export const SettingsProvidersV2: Component = () => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "talon" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "talon" || item.id === "talon-go"}>
