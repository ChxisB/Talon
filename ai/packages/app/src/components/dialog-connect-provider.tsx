import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@talon-ai/sdk/v2/client"
...
import { List, type ListRef } from "@talon-ai/ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "talon"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.talonZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.talonZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.talonZen.visit.prefix")}
                <Link href="https://talon.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.talonZen.visit.link")}
                </Link>
                {language.t("provider.connect.talonZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
