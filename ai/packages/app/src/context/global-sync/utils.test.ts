...
import type { Agent } from "@talon-ai/sdk/v2/client"
...
describe("directoryKey", () => {
  test("normalizes slashes", () => {
    expect(String(directoryKey("C:\\Repos\\sst\\talon"))).toBe("C:/Repos/sst/talon")
    expect(String(directoryKey("C:/Repos/sst/talon"))).toBe("C:/Repos/sst/talon")
  })
