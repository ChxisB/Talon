...
import {
  ...
  type TokenCostEntry,
  type UsagePoint,
} from "@talon-ai/stats-core/domain/home"
import { runtime } from "@talon-ai/stats-core/runtime"
...
const statsHomeFallbackUrl = "https://talon.ai/data/"
...
function getStatsHomeUrl(base: string, requestUrl: string) {
  ...
  if (url.hostname === "stats.talon.ai") return "https://talon.ai/data/"
  if (url.hostname === "stats.dev.talon.ai") return "https://dev.talon.ai/data/"
  return url.toString()
}
