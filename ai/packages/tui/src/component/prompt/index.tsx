...
import type { CommandContext } from "@tui/keymap"
import { createEffect, createMemo, onMount, createSignal, onCleanup, on, Show, Switch, Match } from "solid-js"
import "@tui/spinner/solid"
...
import { useRenderer, useTerminalDimensions, type JSX } from "@tui/solid"
import type { AssistantMessage, FilePart, UserMessage } from "@talon-ai/sdk/v2"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.TALON_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
