...
import { useKeyboard, useTerminalDimensions } from "@tui/solid"
...
export function ErrorComponent(props: { error: Error; reset: () => void; mode?: "dark" | "light" }) {
  ...
  const issueURL = new URL("https://github.com/ChxisB/Talon/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("talon-version", InstallationVersion)
