...
import defaultSoundPath from "@talon-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@talon-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@talon-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@talon-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@talon-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@talon-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "talon"
const DEFAULT_PACK_ID = "talon.default"
