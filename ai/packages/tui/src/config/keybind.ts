...
import type { Binding } from "@tui/keymap"
import type { BindingCommandMap, BindingConfig, BindingDefaults } from "@tui/keymap/extras"
...
export const Definitions = {
  ...
  settings_open: keybind("none", "Open settings dialog"),
