...
import type * as SDK from "@talon-ai/sdk/v2"
...
import { SessionShareTable } from "@talon-ai/core/share/sql"
...
const disabled = process.env["TALON_DISABLE_SHARE"] === "true" || process.env["TALON_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@talon/ShareNext") {}
