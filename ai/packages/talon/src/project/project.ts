...
import { ProjectDirectoryTable, ProjectTable } from "@talon-ai/core/project/sql"
...
import { which } from "@talon-ai/core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@talon-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@talon/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.TALON_FAKE_VCS)
