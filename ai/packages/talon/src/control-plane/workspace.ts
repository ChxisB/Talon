...
import { EventSequenceTable, EventTable } from "@talon-ai/core/event/sql"
import { FSUtil } from "@talon-ai/core/fs-util"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { ProjectV2 } from "@talon-ai/core/project"
import { Slug } from "@talon-ai/core/util/slug"
...
export class Service extends Context.Service<Service, Interface>()("@talon/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        TALON_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        TALON_WORKSPACE_ID: config.id,
        TALON_EXPERIMENTAL_WORKSPACES: "true",
