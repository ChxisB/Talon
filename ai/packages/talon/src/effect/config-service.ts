 ...
 *   "@talon/ServerAuthConfig",
 *   {
 *     password: Config.string("TALON_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("TALON_SERVER_USERNAME").pipe(Config.withDefault("talon")),
 *   },
 * ) {}
 *
