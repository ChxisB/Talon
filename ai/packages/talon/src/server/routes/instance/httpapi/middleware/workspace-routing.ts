...
>()("@talon/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@talon/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.TALON_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.TALON_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-talon-directory"] || process.cwd()
}
