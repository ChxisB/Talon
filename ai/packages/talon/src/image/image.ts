...
export class Service extends Context.Service<Service, Interface>()("@talon/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __TALON_PHOTON_WASM_PATH?: string }).__TALON_PHOTON_WASM_PATH =
