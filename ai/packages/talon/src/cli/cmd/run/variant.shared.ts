...
//
// The saved variant persists across sessions in ~/.local/state/talon/model.json
...
class Service extends Context.Service<Service, VariantService>()("@talon/RunVariant") {}
