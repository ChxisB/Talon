...
import type { Event, GlobalEvent, OpencodeClient } from "@talon-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@talon/RunStreamTransport") {}
