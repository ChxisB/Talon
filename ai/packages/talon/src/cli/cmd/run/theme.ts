...
import { RGBA, SyntaxStyle, type CliRenderer, type ColorInput, type TerminalColors } from "@tui/core"
import type { TuiThemeCurrent } from "@talon-ai/plugin/tui"
...
export async function resolveRunTheme(renderer: CliRenderer): Promise<RunTheme> {
  try {
    ...
    const shared = await import("@talon-ai/tui/context/theme")
