...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@talon/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@talon/ACPDirectory") {}
