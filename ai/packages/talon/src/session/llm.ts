...
import { llmClient } from "@talon-ai/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@talon-ai/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@talon-ai/llm/route"
import type { LLMClientService } from "@talon-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@talon/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @talon-ai/llm. It
