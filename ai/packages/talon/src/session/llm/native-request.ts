import type { JsonSchema, LLMRequest, ProviderMetadata } from "@talon-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@talon-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @talon-ai/llm request objects from talon's session/AI SDK-shaped data.
  return LLM.request({
