...
import type { ProviderMetadata, Usage } from "@talon-ai/llm"
...
import { PartTable, SessionTable } from "@talon-ai/core/session/sql"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".talon", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@talon/Session") {}
