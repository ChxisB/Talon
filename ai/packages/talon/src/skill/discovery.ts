...
import { httpClient, path } from "@talon-ai/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@talon/SkillDiscovery") {}
