...
import { path } from "@talon-ai/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@talon-ai/core/project"
...
export class Service extends Context.Service<Service, Interface>()("@talon/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `talon/${name}`
