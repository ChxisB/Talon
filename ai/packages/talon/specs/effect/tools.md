...
Practical reference for the current tool-migration state in `packages/talon`.
...
Tool tests should use the existing Effect helpers in `packages/talon/test/lib/effect.ts`:
