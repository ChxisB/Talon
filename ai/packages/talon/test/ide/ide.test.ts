...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders TALON_CALLER", () => {
    process.env["TALON_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode TALON_CALLER", () => {
    process.env["TALON_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown TALON_CALLER", () => {
    process.env["TALON_CALLER"] = "unknown"
