...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips talon-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-talon-directory"]).toBeUndefined()
      expect(forwarded["x-talon-workspace"]).toBeUndefined()
