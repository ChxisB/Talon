...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips talon-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-talon-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-talon-directory")).toBeNull()
      expect(result.get("x-talon-workspace")).toBeNull()
