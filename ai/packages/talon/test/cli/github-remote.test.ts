...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/talon.git")).toEqual({ owner: "sst", repo: "talon" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/talon")).toEqual({ owner: "sst", repo: "talon" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/talon.git")).toEqual({ owner: "sst", repo: "talon" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/talon")).toEqual({ owner: "sst", repo: "talon" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/talon.git")).toEqual({ owner: "sst", repo: "talon" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/talon")).toEqual({ owner: "sst", repo: "talon" })
})
