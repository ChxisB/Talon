...
const releaseId = process.env.TALON_RELEASE
if (!releaseId) throw new Error("TALON_RELEASE is required")

const version = process.env.TALON_VERSION
if (!version) throw new Error("TALON_VERSION is required")
...
const macxTarGz = "talon-desktop-mac-x64.app.tar.gz"
const macaTarGz = "talon-desktop-mac-arm64.app.tar.gz"
