...
- PR #13942: https://github.com/anomalyco/talon/pull/13942

## Do Not Translate (Locale Additions)

- `Talon` (preserve casing in prose; keep `talon` only when it is part of commands, package names, paths, or code)
- `Talon Zen`
- `Talon CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `talon` in prose when referring to the product name; use `Talon`
