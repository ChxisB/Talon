...
- PR #15835: https://github.com/anomalyco/talon/pull/15835

## Do Not Translate (Locale Additions)

- `Talon` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `talon` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Talon` in prose, `talon` only for exact technical identifiers
...
- Avoid changing `talon` to `Talon` inside commands, URLs, package names, or code literals
