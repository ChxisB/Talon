...
- PR #10809: https://github.com/anomalyco/talon/pull/10809
- PR #11496: https://github.com/anomalyco/talon/pull/11496

## Do Not Translate (Locale Additions)

- `Talon` (preserve casing in prose; keep `talon` only in commands, package names, paths, or code)
- `Talon CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
