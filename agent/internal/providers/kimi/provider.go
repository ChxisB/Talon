...
// Uses Anthropic Messages API at https://api.moonshot.cn/v1
package kimi
...
func metadata() providers.ProviderMetadata {
	return providers.ProviderMetadata{
		ID:              providerName,
		Name:            "Kimi (Moonshot)",
		Description:     "Kimi API by Moonshot AI - Anthropic Messages API compatible",
		APIType:         "anthropic",
		BaseURL:         defaultBase,
		RequiresAPIKey:  true,
		...
		DefaultModels:   []string{"kimi/kimi-k2", "kimi/kimi-k2.5"},
		ModelPrefix:     "kimi/",
