...
// Uses Anthropic Messages API at https://api.deepseek.com/v1
package deepseek
...
func metadata() providers.ProviderMetadata {
	return providers.ProviderMetadata{
		ID:              providerName,
		Name:            "DeepSeek",
		Description:     "DeepSeek API - Anthropic Messages API compatible",
		APIType:         "anthropic",
		BaseURL:         defaultBase,
		RequiresAPIKey:  true,
		...
		DefaultModels:   []string{"deepseek/deepseek-chat", "deepseek/deepseek-coder"},
