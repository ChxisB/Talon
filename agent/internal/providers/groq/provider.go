...
func metadata() providers.ProviderMetadata {
	return providers.ProviderMetadata{
		ID:              providerName,
		Name:            "Groq",
		Description:     "Groq API - OpenAI-compatible (ultra-fast inference)",
		APIType:         "openai",
		BaseURL:         defaultBase,
		RequiresAPIKey:  true,
		...
		DefaultModels:   []string{"groq/llama-3.3-70b-versatile", "groq/llama-3.1-8b-instant", "groq/mixtral-8x7b"},
		ModelPrefix:     "groq/",
