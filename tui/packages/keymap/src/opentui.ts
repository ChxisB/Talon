import { CliRenderEvents, KeyEvent, RenderableEvents, type CliRenderer, type Renderable } from "@tui/core"
import { Keymap, type HostMetadata, type HostPlatform, type KeymapHost } from "@tui/keymap"
import { registerDefaultKeys, registerEnabledFields, registerMetadataFields } from "@tui/keymap/addons"
...
// Rebrand alias: @tui/keymap/tui → createDefaultTuiKeymap
export const createDefaultTuiKeymap = createDefaultOpenTuiKeymap
