/**
 * Example: serve a React (@tui/react) app over SSH.
 *
 * `@tui/ssh` is renderer-agnostic and hands you a wired `CliRenderer` on
 ...
 *       guest@localhost
 *
 * @tui/react is not a dependency of @tui/ssh; the package stays
