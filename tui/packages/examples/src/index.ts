...
import { measureText } from "@tui/core"
...
function unavailableThreeExample(name: string, description: string): ExampleDefinition {
  return {
    name,
    description: `${description} (Requires @tui/three in Node.js)`,
    unavailableMessage: "This example requires @tui/three and remains disabled in the Node.js examples bundle.",
  }
}
