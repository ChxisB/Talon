...
```typescript
import { addDefaultParsers, getTreeSitterClient } from "@tui/core"
...
```typescript
import { TreeSitterClient } from "@tui/core"
...
```typescript
import { CodeRenderable, RGBA, SyntaxStyle, getTreeSitterClient } from "@tui/core"
...
```typescript
import { pathToFiletype, extToFiletype, infoStringToFiletype } from "@tui/core"
...
```typescript
import { extensionToFiletype, basenameToFiletype } from "@tui/core"
