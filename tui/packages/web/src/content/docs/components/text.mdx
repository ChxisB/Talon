...
```typescript
import { TextRenderable, createCliRenderer } from "@tui/core"
...
```typescript
import { Text, createCliRenderer } from "@tui/core"
...
```typescript
import { TextRenderable, TextAttributes } from "@tui/core"
...
```typescript
import { TextRenderable, t, bold, underline, fg, bg, italic } from "@tui/core"
...
```typescript
import { t, bold, dim, italic, underline, blink, reverse, strikethrough, fg, bg } from "@tui/core"
...
```typescript
import { Text, Box, t, bold, fg } from "@tui/core"
