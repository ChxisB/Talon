...
```typescript
import { TabSelectRenderable, TabSelectRenderableEvents, createCliRenderer } from "@tui/core"
...
```typescript
import { TabSelect, createCliRenderer } from "@tui/core"
...
```typescript
import { TabSelectRenderableEvents, type TabSelectOption } from "@tui/core"
...
```typescript
import { Box, Text, TabSelect, createCliRenderer } from "@tui/core"
