...
````typescript
import { MarkdownRenderable, SyntaxStyle, RGBA, createCliRenderer } from "@tui/core"
...
```typescript
import { MarkdownRenderable, RGBA, SyntaxStyle } from "@tui/core"
...
````typescript
import { BoxRenderable, MarkdownRenderable, TextRenderable, createMarkdownCodeBlockRenderer } from "@tui/core"
