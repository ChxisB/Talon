...
```typescript
import { BoxRenderable, TextRenderable, InputRenderable, createCliRenderer, type RenderContext } from "@tui/core"
...
```typescript
import { Text, Input, Box, createCliRenderer, delegate } from "@tui/core"
...
```typescript
import { BoxRenderable, Text, Input } from "@tui/core"
