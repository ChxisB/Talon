import { OptimizedBuffer, RGBA, type RenderContext } from "@tui/core"
import { ThreeRenderable, THREE } from "@tui/three"
import { extend, type SolidPlugin } from "@tui/solid"
        ...
        return (
          <box flexDirection="column">
            ...
            <box marginTop={1} border borderStyle="single" borderColor="#334155" flexDirection="column">
              <text fg="#93c5fd">3D cube from @tui/three</text>
