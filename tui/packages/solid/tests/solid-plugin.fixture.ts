...
import { createRuntimePlugin, runtimeModuleIdForSpecifier, type RuntimeModuleEntry } from "@tui/core/runtime-plugin"
...
const runtimeResolvedSpecifiers = new Set<string>(["@tui/core", ...Object.keys(additionalRuntimeModules)])
