...
```typescript
import { updateAssets } from "@tui/core/tree-sitter/update-assets"
...
{
  "scripts": {
    "prebuild": "bun node_modules/@tui/core/lib/tree-sitter/update-assets.js --config ./parsers-config.json --assets ./src/parsers --output ./src/parsers.ts",
...
```typescript
import { getTreeSitterClient } from "@tui/core"
