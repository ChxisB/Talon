...
const CORE_PACKAGE_NAME = "@tui/core"
const LOCKSTEP_PACKAGE_PREFIX = "@tui/"
...
function warnOnVersionDrift(lockstepPackages: WorkspacePackage[], sourceVersion: string): void {
  ...
  console.warn("Detected version drift across lock-step packages. Using @tui/core as the source of truth:")
...
function updateCoreOptionalDependencies(packageJson: PackageJson, version: string): string[] {
  ...
  for (const dependencyName of Object.keys(packageJson.optionalDependencies)) {
    if (!dependencyName.startsWith("@tui/core-")) {
      continue
    }
