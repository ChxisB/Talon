...
// quickStyle builds the default Styles (that is, the default theme, Default
		...
		CodeBlock: ansi.StyleCodeBlock{
			...
			Chroma: &ansi.Chroma{
				...
				CommentPreproc: ansi.StylePrimitive{
					Color: hex(palette.Bengal),
				},
				Keyword: ansi.StylePrimitive{
					Color: hex(o.info),
				},
				KeywordReserved: ansi.StylePrimitive{
					Color: hex(palette.Pony),
				},
				KeywordNamespace: ansi.StylePrimitive{
					Color: hex(palette.Pony),
				},
				KeywordType: ansi.StylePrimitive{
					Color: hex(palette.Guppy),
				},
				Operator: ansi.StylePrimitive{
					Color: hex(palette.Salmon),
				},
				...
				NameTag: ansi.StylePrimitive{
					Color: hex(palette.Mauve),
				},
				NameAttribute: ansi.StylePrimitive{
					Color: hex(palette.Hazy),
				},
				NameClass: ansi.StylePrimitive{
					Color:     hex(palette.Salt),
					Underline: new(true),
					Bold:      new(true),
				},
				NameDecorator: ansi.StylePrimitive{
					Color: hex(palette.Citron),
				},
